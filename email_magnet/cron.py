...
def my_cron_job():
    """
    Created a cron job to periodically check if there are new Detailed searches that need to be 
    processed. It first check the list of detail searches with valid email is None.
    Then, it launches the methods to update and save.
